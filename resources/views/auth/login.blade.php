                            ...
                            <div class="card-body">
                                <div class="px-3">
                                    ...
                                    <div class="text-center auth-logo-text">
                                        <h4 class="mt-0 mb-3 mt-5">Let's Get Started Real Estate Project</h4>
                                        <p class="text-muted mb-0">Sign in to continue to Real Estate Project.</p>
                                    ...
                                    <form class="form-horizontal auth-form my-4" method="POST" action="{{ route('login') }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="email" class="form-control @error('email') is-invalid @enderror" name="email" id="email" placeholder="Enter email" value="{{ old('email') }}" autocomplete="off">
                                                @error('email')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="password" class="form-control @error('password') is-invalid @enderror" name="password" id="password" placeholder="Enter password" autocomplete="off">
                                                @error('password')
                                                    <span class="invalid-feedback">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
