...
@section('title', 'Edit Record History')
...
@section('content')
            ...
            <div class="page-title-box">
                <div class="float-right">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('record-history.list') }}">Record History</a></li>
                        <li class="breadcrumb-item active">Edit Record History</li>

                    </ol>
                </div>
                <h4 class="page-title">Edit Record History</h4>
            </div>
            <!--end page-title-box-->
        </div>
        <!--end col-->
    ...
    <div class="row">
        <div class="col-md-12 mx-auto">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('record-history.update', $data->id) }}" method="POST" class="card-box">
                        @csrf
                        <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <a href="{{ route('record.history.pdf', $data->id) }}"
